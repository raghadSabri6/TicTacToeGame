...
public class Hard extends javax.swing.JFrame {
    ...
    private void OTurn(){
        int d = 9 - Xcount + Ocount;
        int result = alphaBeta(1000 , -1000, 100,false,true);
    ...
    private int alphaBeta(int alpha, int beta, int depth ,boolean isMaximizing , boolean firstTime){
        ...
        if(isMaximizing){
            ...
            for(int i=0 ; i<9 ; i++){
                if(buttonUsed[i]==0){
                    ...
                    Xwon[i]=1;
                    turn++;                    
                    int score = alphaBeta(alpha , beta , depth-1 , false , false);
                    buttonUsed[i] = 0;
                    Xcount--;
                    Xwon[i]=0;
                    turn--;
            ...
            for(int i=0 ; i<9 ; i++){
                if(buttonUsed[i]==0){
                    ...
                    Owon[i]=1;
                    turn++;                    
                    int score = alphaBeta(alpha , beta ,depth-1 , true , false);
                    buttonUsed[i] = 0;
                    Ocount--;
                    Owon[i]=0;
                    turn--;
